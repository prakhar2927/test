# CI for a Flask App 
Your mission involves fixing the app in this directory, containerize it and set up a CI for it.
...
2. To run the app execute `flask run`. If it doesn't work, fix it!
...
Using Docker, containerize the flask app so users can run the following two commands:
...
## Bonus Points
- Use a test coverage libraries and export the results as a job artifact